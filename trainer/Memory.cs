...
namespace trainer
{
    public class Memory
    {
        ...
        public Int32 PointerRead(string MemoryAddress_/*, uint bytesToRead*/, int[] Offset/*, out int bytesRead*/)
        {
            uint bytesToRead = 32;
            IntPtr MemoryAddress = (IntPtr)ToDec(MemoryAddress_);
        ...
        public string PointerWrite(string MemoryAddress_, byte[] bytesToWrite, int[] Offset/*, out int bytesWritten*/)
        {
            IntPtr MemoryAddress = (IntPtr)ToDec(MemoryAddress_);
            int iPointerCount = Offset.Length - 1;
            IntPtr ptrBytesWritten;
